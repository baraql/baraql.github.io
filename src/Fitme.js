    ...
    <>
      ...
      <div
        style={{
          height:
            1650 -
            (0.005 * window.innerHeight + 0.05 * window.innerWidth) +
            "px",
          zIndex: "-1",
        }}
      ></div>
      <div
        className={scroll ? "fixedElement" : "notFixedElement"}
        style={{ zIndex: "1" }}
      >
        <FirstDiv />
      </div>
      ...
      <Plx parallaxData={plxAppLogo}>
        ...
        >
          <img
            ...
            alt="Fitme logo"
          />
          <Text style={{ fontFamily: "futura, serif", fontSize: "36px" }}>
            Fitme
          </Text>
        </div>
      </Plx>
  ...
  return (
    ...
    >
      ...
      >
        <img
          src={fitmeSC1}
          alt="Fitme discover page screencap"
          style={{
            pointerEvents: "none",
      ...
      <div>
        ...
        >
          ...
          >
            An eccommerce community
          </Text>
        </Plx>

        <Plx
          parallaxData={plx1Text2}
          style={{
            marginTop: "1vh",
            marginLeft: "2vw",
          }}
        ...
        >
          <a
            href="https://apps.apple.com/us/app/fitme-outfits-made-social/id1543589747"
            target="_blank"
    ...
    <Plx parallaxData={fullDiv2} style={{ zIndex: "-1" }}>
      ...
      >
        ...
        >
          <img
            src={fitmeSC2}
            alt="Fitme profile page screencap"
            style={{
              pointerEvents: "none",
              backgroundColor: "white",
              height: "80vh",
...
function ThirdDiv() {
  return (
    ...
    >
      <div className="item-red">Browse outfits for inspiration.</div>
      <div className="item-red">Easily buy linked clothes.</div>
      <div className="item-red">Express yourself.</div>
      <div className="item-red">Become a fashion influencer.</div>
      <div className="item-red">Sell your clothes.</div>
      <div className="item-red">Grow your brand.</div>
    </div>
  );
}
    ...
    <>
      ...
      >
        <div style={{ textDecoration: "underline" }}>
          How I grew from this project:
        </div>
        <div
          className="statItem"
          style={{ marginRight: "30vw", marginTop: "5vw" }}
        >
          Learned Javascript+Node.JS and Swift+SwiftUI.
        </div>
        <div
          className="statItem"
          style={{ marginLeft: "30vw", marginTop: "5vw" }}
        >
          8,000+ lines of Swift written.
        </div>
        <div
          className="statItem"
          style={{ marginRight: "30vw", marginTop: "5vw" }}
        >
          Designed predictive algorithm.
        </div>
        <div
          className="statItem"
          style={{ marginLeft: "30vw", marginTop: "5vw" }}
        >
          Created scalable, instant, enriched direct messaging with a group
          chats feature.
        </div>
        <div
          className="statItem"
          style={{ marginRight: "30vw", marginTop: "5vw" }}
        >
          Constructed with Google Cloud Platform Firebase (NoSQL).
        </div>
        <div
          className="statItem"
          style={{ marginLeft: "30vw", marginTop: "5vw" }}
        >
          Integrated Sign in With Apple, Google, and email.
        </div>
        <div
          className="statItem"
          style={{ marginRight: "30vw", marginTop: "5vw" }}
        >
          Learned and applied UI/UX design standards.
        </div>
      </div>
    </>
  );
